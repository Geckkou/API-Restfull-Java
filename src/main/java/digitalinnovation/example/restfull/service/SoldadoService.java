...
public class SoldadoService {
    ...
    public SoldadoResponse buscarSoldado(Long id) {
        SoldadoEntity soldado = soldadoRepository.findById(id).orElseThrow(SoldadoNotFoundException::new);
        SoldadoResponse soldadoResponse = resourceSoldado.criarLinksDetalhe(soldado);
    ...
    public Resources <SoldadoListResponse> buscarSoldados(){
        ...
        List<SoldadoListResponse> soldadoStream = all.stream()
                .map(it -> resourceSoldado.criarLinks(it))
